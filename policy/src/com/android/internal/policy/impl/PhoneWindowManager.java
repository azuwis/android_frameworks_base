...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private boolean mHideStatusBarInPortrait = false;
    ...
    public int finishAnimationLw() {
        ...
        if (mStatusBar != null) {
            ...
            if (mForceStatusBar) {
                ...
                // case though.
                if (topIsFullscreen || mHideStatusBarInPortrait || Settings.System.getInt(mContext.getContentResolver(), Settings.System.EXPANDED_DESKTOP_STATE, 0) == 1) {
